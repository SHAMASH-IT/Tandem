...
<section class="mt-160 form-page login-form-page">
    ...
    <div class="form-page-left form-page-half text-center">
        <div class="form-page-left-img">
            <h2 class="banner-heading text-white mb-3"><?=__('Inscrivez-vous')?></h2>
        </div>
    ...
    <div class="form-page-right form-page-half" style="padding-top:20px">
        ...
        <form class="login-form mt-3" action="inscription/send" method="post">
            ...
            <div class="form-group mt-2">
                <label class="form-label text-primary" for="exampleFormControlInput2">Formation</label>
                <input class="form-control" id="exampleFormControlInput2" type="text" placeholder="Formation" name="formation" required>
            </div>
            <div class="form-group mt-2">
            ...
            <button class="btn btn-primary w-100 mt-5 submit-btn" type="submit">S'inscrire</button>
        </form>
        </div>
    </div>
    </div>
