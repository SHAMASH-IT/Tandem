...
?>
    ...
    <div class="edu-breadcrumb-area breadcrumb-style-2 bg-image bg-image--21">
        <div class="video shadow-lg">
            <!-- <iframe title="YouTube video player" class="youtube-player" type="text/html" width="560" height="auto" src="https://youtu.be/xivlrOUx-sg?autoplay=1" frameborder="0" allowFullScreen></iframe> -->
            <iframe id="youtubeVideo" class="mfp-iframe" src="//www.youtube.com/embed/xivlrOUx-sg?autoplay=1&mute=1&controls=0&showinfo=0&loop=1" frameborder="0" allowfullscreen="" height="320" allow="autoplay; encrypted-media"></iframe>
            <!-- <video width="550" height="auto" controls="false"  autoplay muted loop playsinline style="flex-direction: column;" id="firstVideo">
                <source src="<?=URL_LINK?>/public/assets/videos/tandem-teen-workshop-2024.webm" type="video/webm">
