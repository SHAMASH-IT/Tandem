    ...
    <div class="container">
        <div class="breadcrumb-inner">
            <div class="page-title">
                <h1 class="title">Anglais</h1>
            </div>
            <ul class="edu-breadcrumb">
                <li class="breadcrumb-item"><a href="index-one#">Accueil</a></li>
                <li class="separator"><i class="icon-angle-right"></i></li>
                <li class="breadcrumb-item"><a href="<?=URL_LINK?>category">Catégorie</a></li>
                <li class="separator"><i class="icon-angle-right"></i></li>
                <li class="breadcrumb-item active" aria-current="page">Anglais</li>
            </ul>
        </div>
    </div>
            ...
            <div class="sorting-right">
                <div class="layout-switcher">
                    ...
                    <ul class="switcher-btn">
                        <li><a href="#" class="active"><i class="icon-53"></i></a></li>
                        <li><a href="course-four#" class=""><i class="icon-54"></i></a></li>
                    </ul>
                </div>
                ...
                <div class="edu-course course-style-1 course-box-shadow hover-button-bg-white">
                    <div class="inner">
                        <div class="thumbnail">
                            <a href="course-details#">
                                <img src="<?=URL_LINK?>public/assets/images/course/course-07.jpg" alt="Course Meta">
                            </a>
                            <div class="time-top">
                    ...
                    <div class="course-hover-content">
                        <div class="content">
                            ...
                            <h6 class="title">
                                <a href="course-details#">The Complete Camtasia Course for Content Creators</a>
                            </h6>
                            <div class="course-rating">
                                <div class="rating">
                                    <i class="icon-23"></i>
                            ...
                            <a href="course-details#" class="edu-btn btn-secondary btn-small">Enrolled <i class="icon-4"></i></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4 col-xl-3" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                <div class="edu-course course-style-1 course-box-shadow hover-button-bg-white">
                    <div class="inner">
                        <div class="thumbnail">
                            <a href="course-details#">
                                <img src="<?=URL_LINK?>public/assets/images/course/course-04.jpg" alt="Course Meta">
                            </a>
                            <div class="time-top">
                    ...
                    <div class="course-hover-content">
                        <div class="content">
                            ...
                            <span class="course-level">Intermediate</span>
                            <h6 class="title">
                                <a href="course-details#">Starting SEO as your Home Based Business</a>
                            </h6>
                            <div class="course-rating">
                                <div class="rating">
                                    <i class="icon-23"></i>
            ...
            <div class="col-md-6 col-lg-4 col-xl-3" data-sal-delay="200" data-sal="slide-up" data-sal-duration="800">
                <div class="edu-course course-style-1 course-box-shadow hover-button-bg-white">
                    <div class="inner">
                        <div class="thumbnail">
                            <a href="course-details#">
                                <img src="<?=URL_LINK?>public/assets/images/course/course-05.jpg" alt="Course Meta">
                            </a>
                            <div class="time-top">
                    ...
                    <div class="course-hover-content">
                        <div class="content">
                            ...
                            <span class="course-level">Beginner</span>
                            <h6 class="title">
                                <a href="course-details#">Building A Better World One Student At A Time</a>
                            </h6>
                            <div class="course-rating">
                                <div class="rating">
                                    <i class="icon-23"></i>
            ...
            <div class="col-md-6 col-lg-4 col-xl-3" data-sal-delay="250" data-sal="slide-up" data-sal-duration="800">
                <div class="edu-course course-style-1 course-box-shadow hover-button-bg-white">
                    <div class="inner">
                        <div class="thumbnail">
                            <a href="course-details#">
                                <img src="<?=URL_LINK?>public/assets/images/course/course-06.jpg" alt="Course Meta">
                            </a>
                            <div class="time-top">
                                <span class="duration"><i class="icon-61"></i>4 Weeks</span>
                            </div>
                    ...
                    <div class="course-hover-content">
                        <div class="content">
                            ...
                            <span class="course-level">Beginner</span>
                            <h6 class="title">
                                <a href="course-details#">Java Programming Masterclass for Software Developers</a>
                            </h6>
                            <div class="course-rating">
                                <div class="rating">
                                    <i class="icon-23"></i>
            ...
            <div class="col-md-6 col-lg-4 col-xl-3" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                <div class="edu-course course-style-1 course-box-shadow hover-button-bg-white">
                    <div class="inner">
                        <div class="thumbnail">
                            <a href="course-details#">
                                <img src="<?=URL_LINK?>public/assets/images/course/course-24.jpg" alt="Course Meta">
                            </a>
                            <div class="time-top">
                    ...
                    <div class="course-hover-content">
                        <div class="content">
                            ...
                            <span class="course-level">Beginner</span>
                            <h6 class="title">
                                <a href="course-details#">Angular & NodeJS - The MEAN Stack Guide [2021 Edition]</a>
                            </h6>
                            <div class="course-rating">
                                <div class="rating">
                                    <i class="icon-23"></i>
            ...
            <div class="col-md-6 col-lg-4 col-xl-3" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                <div class="edu-course course-style-1 course-box-shadow hover-button-bg-white">
                    <div class="inner">
                        <div class="thumbnail">
                            <a href="course-details#">
                                <img src="<?=URL_LINK?>public/assets/images/course/course-25.jpg" alt="Course Meta">
                            </a>
                            <div class="time-top">
                    ...
                    <div class="course-hover-content">
                        <div class="content">
                            ...
                            <span class="course-level">Beginner</span>
                            <h6 class="title">
                                <a href="course-details#">The Complete React Developer Course (Hooks and Redux)</a>
                            </h6>
                            <div class="course-rating">
                                <div class="rating">
                                    <i class="icon-23"></i>
            ...
            <div class="col-md-6 col-lg-4 col-xl-3" data-sal-delay="200" data-sal="slide-up" data-sal-duration="800">
                <div class="edu-course course-style-1 course-box-shadow hover-button-bg-white">
                    <div class="inner">
                        <div class="thumbnail">
                            <a href="course-details#">
                                <img src="<?=URL_LINK?>public/assets/images/course/course-26.jpg" alt="Course Meta">
                            </a>
                            <div class="time-top">
                                <span class="duration"><i class="icon-61"></i>3 Weeks</span>
                            </div>
                    ...
                    <div class="course-hover-content">
                        <div class="content">
                            ...
                            <span class="course-level">Beginner</span>
                            <h6 class="title">
                                <a href="course-details#">Build an app with ASPNET Core & Angular from Scratch Begainer</a>
                            </h6>
                            <div class="course-rating">
                                <div class="rating">
                                    <i class="icon-23"></i>
            ...
            <div class="col-md-6 col-lg-4 col-xl-3" data-sal-delay="250" data-sal="slide-up" data-sal-duration="800">
                <div class="edu-course course-style-1 course-box-shadow hover-button-bg-white">
                    <div class="inner">
                        <div class="thumbnail">
                            <a href="course-details#">
                                <img src="<?=URL_LINK?>public/assets/images/course/course-27.jpg" alt="Course Meta">
                            </a>
                            <div class="time-top">
                                <span class="duration"><i class="icon-61"></i>3 Weeks</span>
                            </div>
                    ...
                    <div class="course-hover-content">
                        <div class="content">
                            ...
                            <span class="course-level">Beginner</span>
                            <h6 class="title">
                                <a href="course-details#">Become a WordPress Developer: Unlocking Power with Code</a>
                            </h6>
                            <div class="course-rating">
                                <div class="rating">
                                    <i class="icon-23"></i>
