            ...
            <div class="row align-items-center">
                <div class="col-lg-6 edu-order-md-2">
                    <div class="banner-content sal-animate" data-sal-delay="150" data-sal="slide-up" data-sal-duration="1000">
                        <h1 style="text-align: left;" class="title sal-animate text-right" style="text-align: left;" data-sal-delay="100" data-sal="slide-up" data-sal-duration="1000">
                            SPECIALIZED COURSE
                        </h1>
                        <h2 style="text-align: left;">50-HOUR ONLINE TEACHING IELTS PREPARATION</h2>
                    </div>
                </div>
                <div class="col-lg-6 edu-order-md-1">
                    <div class="banner-thumbnail">
                        <div class="thumbnail sal-animate" data-sal-delay="150" data-sal="slide-left" data-sal-duration="1000">
                            <img src="<?=URL_LINK?>public/assets/images/banner/girl-1.webp" alt="Pi-chart Image">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="features-area-5">
        <div class="container edublink-animated-shape">
            <div class="section-title section-center sal-animate" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                <span class="pre-title pre-textsecondary">50-H IELTS</span>
                <h2 class="title">SPECIALIZED COURSE IELTS PREPARATION</h2>
                ...
                <div class="col-lg-12 mx-auto sal-animate" data-sal-delay="50" data-sal="slide-up" data-sal-duration="800">
                    <div class="about-content">
                        ...
                        <p style="text-align: justify; font-size: 2rem">
                            The International English Language Testing System (IELTS) is a widely accepted system for assessing the English language skills of non-native speakers.
                        </p>
                        <p style="text-align: justify; font-size: 2rem">
                            Along with TOEFL, it is one of the main tests taken by TANDEM students who wish to continue their studies at higher education institutions in English-speaking countries around the world.
                        </p>
                        <p style="text-align: justify; font-size: 2rem">
                            Additionally, IELTS is required for employment and immigration. Last year alone he had 3.5 million English language learners take his IELTS test and its importance cannot be overstated.
                        </p>
                        <p style="text-align: justify; font-size: 2rem">
                            TANDEM offers English teachers the opportunity to earn certification in TOEFL or IELTS preparation.
                        </p>
                        <p style="text-align: justify; font-size: 2rem">
                            By completing her 50-hour IELTS preparation program, teachers will gain valuable skills that they can pass on to their future students.
                        </p>
                        <p style="text-align: justify; font-size: 2rem">
                            In addition to gaining a thorough understanding of the test structure, you will also gain skills in scoring individual sections of the test as well as the ability to effectively develop specific skills.
                        </p>
                        <p style="text-align: justify; font-size: 2rem">
                            It is important to note that the ability to develop a general English course is a prerequisite before starting this program. If you have no experience teaching English, we recommend starting with the 120-hour TEFL certification, which can be taken online or in the classroom.
                        </p>
                        <p style="text-align: justify; font-size: 2rem">
                            Once you have your TEFL certification, you can easily move on to her professional IELTS preparation course. Get started today.
                        </p>
                        <p style="text-align: justify; font-size: 2rem">
                            Then you'll have the opportunity to complete your Specialist Course in no time, earn her coveted IELTS Preparation Teacher Certification, and showcase your expertise to the world.
                        </p>
                    </div>
                    <div class="about-content">
                        <h4>WHAT YOU CAN EXPECT FROM THE PROGRAM</h4>
                        <ul class="features-list">
                            <li>Material you can copy for class use.</li>
                            <li>Sample IELTS tests.</li>
                            <li>How to plan an effective preparation program.</li>
                            <li>How to teach engaging individual lessons.</li>
                            <li>Tips and tricks for a great exam day.</li>
                            <li>Preparing students for band score 9.</li>
                            <li>How to teach test-taking strategies.</li>
                            <li>Sample authentic materials.</li>
                            <li>Engaging in class activities.</li>
                            <li>Gamification to keep students’ attention.</li>
                            <li>Assignments for submission and grading by the tutor.</li>
                        </ul>
                    </div>
                    <div class="about-content">
                        <p style="text-align: justify; font-size: 2rem">
                            The 50-hour IELTS Preparation Specialization is designed for English language teachers who require in-depth knowledge of academic and general English tests to be able to effectively deliver preparation courses in academic or academic contexts.
                        </p>
                    </div>
                </div>
            </div>
