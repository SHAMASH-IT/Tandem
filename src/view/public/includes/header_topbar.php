        ...
        <div class="header-top">
            <div class="header-top-left">
                <ul class="header-info">
                    <li><a href="<?=URL_LINK?>contact"><i class="icon-envelope"></i>Contact</a></li>
                    <li><a href="<?=URL_LINK?>inscription"><i class="icon-45"></i> Inscription</a></li>
...
<!--                    </li>-->
                    <li class="header-btn">
                        <a href="https://tandem.mtderp.com/Tandem/Questions/testniveau" style="color: black"
                           class="edu-btn btn-medium">Test en ligne <i class="icon-4" style="color: black"></i></a>
                    </li>
                </ul>
            </div>
        </div>
