<section class="why-choose-area-3 edu-section-gap">
                ...
                <div class="row row--45">
                    <div class="section-title-flex section-title" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                        <div class="left-content">
                            <h2 class="title">We Providing The <br> Best <span class="color-secondary">Quality Online </span> Courses</h2>
            ...
            <ul class="shape-group">
                ...
                <li class="shape-3">
                    <img data-parallax='{"x": 0, "y": 100}' src="<?=URL_LINK?>public/assets/images/faq/shape-12.png" alt="shape">
                </li>
            </ul>
        </section>