                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="testimonial-grid">
                                <div class="thumbnail">
                                    <img src="<?=URL_LINK?>public/assets/images/testimonial/testimonial-01.png" alt="Testimonial">
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-grid">
                                <div class="thumbnail">
                                    <img src="<?=URL_LINK?>public/assets/images/testimonial/testimonial-02.png" alt="Testimonial">
                                    <span class="qoute-icon"><i class="icon-26"></i></span>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-grid">
                                <div class="thumbnail">
                                    <img src="<?=URL_LINK?>public/assets/images/testimonial/testimonial-03.png" alt="Testimonial">
                                    <span class="qoute-icon"><i class="icon-26"></i></span>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-grid">
                                <div class="thumbnail">
                                    <img src="<?=URL_LINK?>public/assets/images/testimonial/testimonial-04.png" alt="Testimonial">
                                    <span class="qoute-icon"><i class="icon-26"></i></span>
